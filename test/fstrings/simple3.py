...
hello         : meta.fstring.python, source.sage, string.interpolated.python, string.quoted.single.python
...
:f            : meta.fstring.python, source.sage, storage.type.format.python
 ...
 times        : meta.fstring.python, source.sage, string.interpolated.python, string.quoted.single.python
