...
from          : keyword.control.flow.python, meta.class.inheritance.python, meta.class.python, source.sage
==            : keyword.operator.comparison.python, meta.class.inheritance.python, meta.class.python, source.sage
12            : constant.numeric.dec.python, meta.class.inheritance.python, meta.class.python, source.sage
