...
Exception     : meta.class.inheritance.python, meta.class.python, source.sage, support.type.exception.python
...
MyObj         : entity.other.inherited-class.python, meta.class.inheritance.python, meta.class.python, source.sage
