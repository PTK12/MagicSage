...
metaclass     : meta.class.inheritance.python, meta.class.python, source.sage, support.type.metaclass.python
=             : keyword.operator.assignment.python, meta.class.inheritance.python, meta.class.python, source.sage
FooMeta       : entity.other.inherited-class.python, meta.class.inheritance.python, meta.class.python, source.sage
